      ...
      <>
        ...
        <div className="relative w-full h-80 mb-8 overflow-hidden full-bleed-header">
          {category.icon ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-purple-900/40 to-purple-600/40 flex items-center justify-center">
              <div className="text-white/60 text-center p-8">
                <svg className="w-24 h-24 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <p className="text-sm">Nicio imagine setată pentru această categorie</p>
              </div>
            </div>
          )}
        ...
        <main className="container p-0">
          ...
          <div className="mt-6">
            <Link href="/" className="text-white hover:text-slate-200">Înapoi</Link>
          </div>
        </main>
      </>
    );
